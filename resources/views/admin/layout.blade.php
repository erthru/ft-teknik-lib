...
<body>
    <header class="bg-primary text-white">
        <a href="#collapseSidebar" class="pr-3 header-toggler" data-toggle="collapse"><i
                class="fas fa-bars fa-1x text-white"></i></a>
        <a class="text-light" href="/admin"><span><strong>DASHBOARD ADMIN</strong></span></a>
        <a class="text-light" style="position:absolute; right: 16px" href="/admin/logout"><i
                ...
                <form method="post" action="/admin/change_password?id={{ session('id') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password_confirmation" placeholder="Masukan password lagi"
                                class="form-control" required>
                        </div>
                    </div>
