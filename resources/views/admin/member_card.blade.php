    ...
    <div class="mt-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-12">
                        <div style="width: min-content">
                            <div id="cardFront">
                                <div class="text-white card-init" style="background-image: url('{{ url('/img/bg_card.jpg') }}')">
                ...
                <button class="btn btn-success" data-target="#modalPrint" data-toggle="modal">Cetak</button>
            </div>
        </div>
    </div>
